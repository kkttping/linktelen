...
export default function CardOpportunities(props) {
    ...
    return (
        <div className='card_opportunities' onClick={() => {if(isModalOpen)return; setIsModalOpen(true) }}>
            {contextHolder}
            <div>
            ...
            <span className='readmore' ><span></span></span>
            <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={[]} width={720}>
                <div className='content'>
                    ...
                    <div className='infomation'>
                        {data?.country&&<div className='item'>
                            <div className='type'>Country</div>
                            <div className='info'>{data?.country}</div>
                        </div>}
                        {data?.Place&&<div className='item'>
                            <div className='type'>City</div>
                            <div className='info'>{data?.Place}</div>
                        </div>}
                        ...
                        <div className='form'>
                            ...
                            >
                                <Row justify={'center'}>
                                    ...
                                    <Col >
                                        <div >
                                            {data.link&&<div className='to_website'>
                                                <a  href={data.link} target="_blank" rel="noreferrer">Or go to the recruitment website {'>'} </a>
                                            </div>}
                                        </div>
                                    </Col>
                                </Row>
